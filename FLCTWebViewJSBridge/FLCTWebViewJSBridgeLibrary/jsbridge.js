...
(function(WIN, DOC) {
  var BRIDGE_EVENT, FLCTCommonMessage, FLCTJSBridge, readyEvent;
  ...
  FLCTCommonMessage = (function() {
    ...
    FLCTCommonMessage.prototype.messageFormat = function() {
      return {
        ...
        'eventData': this.data,
        'eventCallBackId': this.callBackId
      };
    };
  ...
  FLCTJSBridge = (function() {
    var CLINET_CALLBACK_EVENTNAME, callBackList, eventList, _responseUniqueId, _sendMessage;
    ...
    FLCTJSBridge.prototype._getMessage = function(message) {
